...
namespace ScriptableObjectArchitecture.Editor
{
 //   [CustomEditor(typeof(BaseVariable<>), true)]
    public class BaseVariableEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _runtimeCalueProperty;
        ...
        {
            _runtimeCalueProperty = serializedObject.FindProperty("runtimeValue");
        ...
        public override void OnInspectorGUI()
        {
            ...
            DrawValue();
            if (Target.propNames != null)
            {
                foreach (var propName in Target.propNames)
                {
        ...
        {
            GenericPropertyDrawer.DrawPropertyDrawerLayout(_runtimeCalueProperty, Target.Type);
  ...
  //  [CustomEditor(typeof(BaseVariable<,>), true)]
    public class BaseVariableWithEventEditor : BaseVariableEditor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                target.GetType().GetMethod("Raise")?.Invoke(target, null);
            }

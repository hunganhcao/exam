...
{	
	...
	public static class MMEventManager 
	{
		...
		public static void AddListener<MMEvent>( MMEventListener<MMEvent> listener )
		{
		...
		/// <param name="listener">listener.</param>
		/// <typeparam name="MMEvent">The event type.</typeparam>
		public static void RemoveListener<MMEvent>( MMEventListener<MMEvent> listener )
		{
			Type eventType = typeof( MMEvent );
		...
		public static void TriggerEvent<MMEvent>( MMEvent newEvent ) 
		{
